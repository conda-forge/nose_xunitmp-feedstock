About nose_xunitmp-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nose_xunitmp-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Ignas/nose_xunitmp
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6255&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nose_xunitmp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nose_xunitmp` can be installed with `conda`:
...
```
mamba install nose_xunitmp
```

It is possible to list all of the versions of `nose_xunitmp` available on your platform with `conda`:
...
```
mamba search nose_xunitmp --channel conda-forge
```
...
mamba repoquery search nose_xunitmp --channel conda-forge

# List packages depending on `nose_xunitmp`:
mamba repoquery whoneeds nose_xunitmp --channel conda-forge

# List dependencies of `nose_xunitmp`:
mamba repoquery depends nose_xunitmp --channel conda-forge
```
